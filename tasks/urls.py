...
urlpatterns = [
    ...
    path("volunteers/create/", VolunteerCreateView.as_view(),
         name="volunteer-create"),
    path("volunteers/update/<int:pk>/", VolunteerUpdateView.as_view(),
         name="volunteer-update"),
    path("volunteers/delete/<int:pk>/", VolunteerDeleteView.as_view(),
    ...
    path("reports/create/", ReportCreateView.as_view(),
         name="report-create"),
    path("reports/update/<int:pk>/", ReportUpdateView.as_view(),
         name="report-update"),
    path("reports/delete/<int:pk>/", ReportDeleteView.as_view(),
         name="report-delete"),
